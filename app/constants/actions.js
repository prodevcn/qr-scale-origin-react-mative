...
export const FETCH_CATEGORY_DETAIL = createRequestTypes('FETCH_CATEGORY_DETAIL');
...
export const FETCH_ATTRIBUTE_DETAIL = createRequestTypes('FETCH_ATTRIBUTE_DETAIL');
...
export const FETCH_PRODUCT_ASSEMBLYLIST = createRequestTypes('FETCH_PRODUCT_ASSEMBLYLIST');
export const FETCH_PRODUCT_VARIANT_LIST = createRequestTypes('FETCH_PRODUCT_VARIANT_LIST');
export const FETCH_PRODUCT_CATEGORY_LIST = createRequestTypes('FETCH_PRODUCT_CATEGORY_LIST');
export const DELETE_PRODUCT_CATEGORY = createRequestTypes('DELETE_PRODUCT_CATEGORY');
export const SAVE_PRODUCT_CATEGORY = createRequestTypes('SAVE_PRODUCT_CATEGORY');
//#endregion Product

//#region Customer
export const FETCH_CUSTOMER_DETAIL = createRequestTypes('FETCH_CUSTOMER_DETAIL');
...
export const FETCH_CUSTOMER_SEARCH = createRequestTypes('FETCH_SUPPLIER_SEARCH');
//#endregion Customer
...
export const FETCH_LOCATION_DETAIL = createRequestTypes('FETCH_LOCATION_DETAIL');
...
export const FETCH_PURCHASEORDER_LIST = createRequestTypes('FETCH_PURCHASEORDER_LIST');
export const FETCH_PURCHASEORDER_DETAIL = createRequestTypes('FETCH_PURCHASEORDER_DETAIL');
...
export const PURCHASEORDERLIST_SAVE = createRequestTypes('PURCHASEORDERLIST_SAVE');

export const FETCH_SALESORDER_LIST = createRequestTypes('FETCH_SALESORDER_LIST');
export const FETCH_SALESORDER_DETAIL = createRequestTypes('FETCH_SALESORDER_DETAIL');
...
export const FETCH_PRODUCT_CATEGORY_DETAIL = createRequestTypes('FETCH_PRODUCT_CATEGORY_DETAIL');
export const PRODUCT_CATEGORY_UPDATE = 'PRODUCT_CATEGORY_UPDATE';
export const PRODUCT_CATEGORY_SAVE = createRequestTypes('PRODUCT_CATEGORY_SAVE');
...
export const FETCH_WAREHOUSE_DETAIL = createRequestTypes('FETCH_WAREHOUSE_DETAIL');
...
export const FETCH_SUPPLIER_DETAIL = createRequestTypes('FETCH_SUPPLIER_DETAIL');
...
export const FETCH_SUPPLIER_SEARCH = createRequestTypes('FETCH_SUPPLIER_SEARCH');
//#endregion Supplier

//#region ProductAudit
export const FETCH_PRODUCTAUDIT_LIST = createRequestTypes('FETCH_PRODUCTAUDIT_LIST');
export const FETCH_PRODUCTAUDIT_DETAIL = createRequestTypes('FETCH_PRODUCTAUDIT_DETAIL');
export const PRODUCTAUDIT_APPROVE_VALUE = createRequestTypes('PRODUCTAUDIT_APPROVE_VALUE');
export const PRODUCTAUDIT_DECLINE_VALUE = createRequestTypes('PRODUCTAUDIT_DECLINE_VALUE');
export const PRODUCTAUDIT_ALLDECLINE_VALUE = createRequestTypes('PRODUCTAUDIT_ALLDECLINE_VALUE');
export const PRODUCTAUDIT_ALLAPPROVE_VALUE = createRequestTypes('PRODUCTAUDIT_ALLAPPROVE_VALUE');
...
export const FETCH_SHIPPINGSETTING_LIST = createRequestTypes('FETCH_SHIPPINGSETTING_LIST');
export const FETCH_SHIPPINGSETTING_DETAIL = createRequestTypes('FETCH_SHIPPINGSETTING_DETAIL');
...
export const FETCH_IMAGESIZE_SETTING_LIST = createRequestTypes('FETCH_IMAGESIZE_SETTING_LIST');
export const FETCH_IMAGESIZE_SETTING_DETAIL = createRequestTypes('FETCH_IMAGESIZE_SETTING_DETAIL');
export const IMAGESIZE_SETTING_FIELD_UPDATE = 'IMAGESIZE_SETTING_FIELD_UPDATE';
export const IMAGESIZE_SETTING_SAVE = createRequestTypes('IMAGESIZE_SETTING_SAVE');
...
export const FETCH_CUSTOMENTITYFAMILY_DETAIL = createRequestTypes('FETCH_CUSTOMENTITYFAMILY_DETAIL');
export const FETCH_CUSTOMENTITYFAMILY_LIST = createRequestTypes('FETCH_CUSTOMENTITYFAMILY_LIST');
export const DELETE_CUSTOMENTITYFAMILY = createRequestTypes('DELETE_CUSTOMENTITYFAMILY');
export const CUSTOMENTITYFAMILY_PANEL_ATTRIBUTE_ADD = 'CUSTOMENTITYFAMILY_PANEL_ATTRIBUTE_ADD';
export const CUSTOMENTITYFAMILY_PANEL_ATTRIBUTE_REMOVE = 'CUSTOMENTITYFAMILY_PANEL_ATTRIBUTE_REMOVE';
export const CUSTOMENTITYFAMILY_NEW_PANEL = 'CUSTOMENTITYFAMILY_NEW_PANEL';
export const CUSTOMENTITYFAMILY_FIELD_UPDATE = 'CUSTOMENTITYFAMILY_FIELD_UPDATE';
export const CUSTOMENTITYFAMILY_PANEL_LAYOUT_UPDATE = 'CUSTOMENTITYFAMILY_PANEL_LAYOUT_UPDATE';
export const SAVE_CUSTOMENTITYFAMILY = createRequestTypes('SAVE_CUSTOMENTITYFAMILY');

export const FETCH_CUSTOMENTITYROW_DETAIL = createRequestTypes('FETCH_CUSTOMENTITYROW_DETAIL');
export const FETCH_CUSTOMENTITYROW_LIST = createRequestTypes('FETCH_CUSTOMENTITYROW_LIST');
export const DELETE_CUSTOMENTITYROW = createRequestTypes('DELETE_CUSTOMENTITYROW');
...
export const SAVE_CUSTOMENTITYROW_VIEW = createRequestTypes('SAVE_CUSTOMENTITYROW_VIEW');
export const APPLY_CUSTOMENTITYROW_VIEW = 'APPLY_CUSTOMENTITYROW_VIEW';
export const DELETE_CUSTOMENTITYROW_VIEW = createRequestTypes('DELETE_CUSTOMENTITYROW_VIEW');
export const FETCH_CUSTOMENTITYROW_SEARCH = createRequestTypes('FETCH_CUSTOMENTITYROW_SEARCH');

//#region Shipping
export const FETCH_SHIPPING_LIST = createRequestTypes('FETCH_SHIPPING_LIST');
export const FETCH_SHIPPING_DETAIL = createRequestTypes('FETCH_SHIPPING_DETAIL');
