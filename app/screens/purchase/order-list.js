  ...
  goToDetail = (order) => {
    if (order.status === 'Confirmed') {
      this.setState({loading: true}, () => {
        Actions.purchaseOrderStartProcessing.bind(this)(order.purchaseOrderId).then(() => {
          this.setState({loading: false}, () => {
            this.props.navigation.navigate('OrderProcess', {purchaseOrderId: order.purchaseOrderId, orderId: order.orderId});
          });
        });
      });
    } else {
