...
class PickStockDetail extends StackScreen {
  ...
  onCorrectPress = () => {
    ...
    this.setState({quantity, modifyNumber: 'correct'}, () => this.openDrawerWith('modifyNumber'));
  };

  onMovePress = () => {
    this.setState({modifyNumber: 'move'}, () => this.openDrawerWith('scanNewLocation'));
  };
          ...
          renderNavigationView={() =>
            drawerContext === 'modifyNumber' ? (
              <ModifyNumber
                ...
                max={this.state.modifyNumber === 'move' ? location.quantity : null}
              ...
              <Barcode
                ...
                scanTo="location"
                message={strings.MobileUI[`Barcode.Messages.targetLocation`] || 'Locale Error'}
