...
class SelectBatchList extends StackScreen {
  ...
  loadRefreshData = () => {
    ...
    Actions.getBatchListByFilter({pageNumber, pageSize, status: 0}).then(data => {
      if (data.succeeded) {
        ...
        {loading ? (
          ...
          <View style={styles.wrapper}>
            <SelectList
              ...
              onEndReachedThreshold={this.state.hasNextPage ? parseInt((4 / this.state.data.length).toFixed(2)) : null}
                ...
                <View style={styles.batchView}>
                  <View style={styles.batchValuesView}>
                    ...
                    <View style={styles.additionalColumn}>
                      <Text style={styles.batchValueText}>
                        23/34
                      </Text>
                    </View>
                </View>
