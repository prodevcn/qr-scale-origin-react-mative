...
class BatchInitial extends StackScreen {
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={[styles.buttons]}>
          <Button
            ...
            text={strings.MobileUI[`BatchPicking.BatchInitial.Button.BatchList`] || 'Locale Error'}/>
          <Button
            style={{
              container: [styles.buttonContainer],
              text: [styles.buttonText]
            ...
            text={strings.MobileUI[`BatchPicking.BatchInitial.Button.Cart`] || 'Locale Error'}/>
        </View>
      </SafeAreaView>
    );
  }
