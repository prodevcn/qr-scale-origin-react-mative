...
class FilterTabsSettings extends React.PureComponent {
  ...
  save = () => {
    this.setState({isSaving: true}, () =>
      this.props
        .onSave(this.state.model)
        .then(() => this.setState({isSaving: false, model: _.cloneDeep(FilterTabsSettings.getBaseModel())}, this.props.onClose))
    );
  };
          ...
          <Text style={styles.titleText}>
            {isNew
              ...
              : `${strings.MobileUI['FilterTabsSettings.Title.EditFilter'] ||
                  'Locale Error'} (${this.props.filter.name})`}
          </Text>
        </View>
        <View style={styles.contentContainer}>
          ...
          <View style={{flexDirection: 'row'}}>
            <Picker
              ...
              onValueChange={val => this.setModelData('filter.countryId', val)}
