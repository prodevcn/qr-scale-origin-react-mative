...
class HaydiGoLogo extends React.Component {
  ...
  render() {
    ...
    return (
      <View style={[styles.haydiGoLogo, styles[size || 'md'], (position ? styles[position] : null), style]}>
        <Image
          source={this.getLogoPath()}
...
HaydiGoLogo.propTypes = {
  ...
  style: PropTypes.any,
  position: PropTypes.oneOf(['leftTop', 'rightTop', 'leftBottom', 'rightBottom'])
};
