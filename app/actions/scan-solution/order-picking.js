...
export default {
  ...
  getFilters: () =>
    new Promise(resolve =>
      CreateAxios().then(axios =>
        axios.get(`${PATH}/getFilters`).then(result => {
          resolve(result.data);
        })
      )
    ),
  ...
  filterSave: filter =>
    new Promise(resolve =>
      CreateAxios().then(axios =>
        axios.post(`${PATH}/filterSave`, filter).then(result => {
          resolve(result.data);
        })
      )
    ),
  ...
  filterDelete: filterId =>
    new Promise(resolve =>
      CreateAxios().then(axios =>
        axios.get(`${PATH}/filterDelete`, {params: {filterId}}).then(result => {
          resolve(result.data);
        })
      )
    ),
  ...
  checkCartTrayAvailability: (cartTrayId, pickListId) =>
    new Promise(resolve => {
      CreateAxios().then(axios =>
        axios
          .get(`${PATH}/CheckCartTrayAvaliability`, {params: {cartTrayId, pickListId}})
          .then(result => {
            resolve(result.data);
